import decentralized_row_means.local as drm_local
import decentralized_row_means.remote as drm_remote
...
import decentralized_pca.local as dpca_local
import decentralized_pca.remote as dpca_remote
...
GROUP_ICA_REMOTE = [
    dict(
        do=[
            gica_remote.gica_remote_init_env,
            gica_remote.gica_remote_ica
        ],
